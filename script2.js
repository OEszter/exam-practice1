...
/* function getHighestPopCountries(countriesData, n) {
    const copiedCountries = [...countriesData]
    let sortedCountries = countriesData.sort((a, b) => (b.population - a.population)) 
...
console.log(getHighestPopCountries(countries, 10)) */
